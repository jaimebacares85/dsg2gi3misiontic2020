...
<!-- Fin Header -->
    ...
    <div class="container-fluid" style="background-color: #ffffff;" >
        <h2 class="text-center">Heladería</h2>
        ...
        <div class="container-fluid"> 
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4"> 
                    <div class="card text-center"> 
                        <div class="d-flex justify-content-center"> 
                                <img src="../assets/cono.png" alt="Venta Cono de Helado" title="Venta Cono de Helado" />
                        </div> 
                            
                                <div class="card-body"> 
                                    <h5 class="card-title">Cono de Helado</h5> 
                                    <p class="card-text">Disfruta del más rico Cono de 
                                    Helado Listo, las mejores cremas las traemos para que 
                                    las disfrutes.</p> 
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4"> 
                    <div class="card text-center"> 
                        <div class="d-flex justify-content-center"> 
                                <img src="../assets/canasta.png" alt="Venta Canasta de Helado" title="Venta Canasta de Helado" />
                        </div> 
                            
                                <div class="card-body"> 
                                    <h5 class="card-title">Canasta de Helado</h5> 
                                    <p class="card-text">La Canasta de Helado Listo sirve 
                                    para que los más pequeños disfruten su helado sin que se
                                    desborde.
                                    </p> 
                                    <a href="/comprar" class="btn btn-success">Comprar</a> 
                                </div> 
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4"> 
                    <div class="card text-center"> 
                        <div class="d-flex justify-content-center"> 
                                <img src="../assets/brownie.png" alt="Venta Brownie" title="Venta Brownie" />
                        </div> 
                            
                                <div class="card-body"> 
                                    <h5 class="card-title">Bebidas</h5> 
                                    <p class="card-text">Disfruta el Brownie con Helado de 
                                    Vainilla caliente o frío y con un toque que le da
